...
public class Adactin {
	public static void main(String[] args) throws Throwable {
	    ...
	    driver.findElement(By.id("username")).sendKeys("Manoth133");
	    driver.findElement(By.id("password")).sendKeys("M@noth678");
	    ...
	    driver.findElement(By.xpath("//input[@id='first_name']")).sendKeys("Manoth");
...
TakesScreenshot t = (TakesScreenshot) driver;
		...
		File d = new File("C:\\Users\\Smart\\eclipse-workspace\\Selenium_Bs\\Screenshoot\\adatin.png");
